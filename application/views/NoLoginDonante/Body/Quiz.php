            ...
            <div class="col-md-12 mb-3">
                <div class="card">
                    <div class="card-header">
                        <span><i class="bi bi-card-list" style="border: 5px; font-size: 20px;"></i></span> Responda a las siguientes preguntas
                    </div>
                    <div class="card-body">
                     <?php if (!empty($requests) && $requests[0]['resultado'] == 'Apto'): ?>
                        ...
                        <?php endif; ?>
                        <form id="formRegistro" action="<?php echo base_url('Nologin/info/process_quiz'); ?>" method="post">                    
                            <ul>
                                <li>
                                    <h3>ENFERMEDADES</h3>
                                    <ul>
